...
/snap/bin/microk8s kubectl delete deployment $PROJECT_NAME-static -n $PROJECT_NAME-$HOST_TYPE --now
/snap/bin/microk8s kubectl delete deployment $PROJECT_NAME-server -n $PROJECT_NAME-$HOST_TYPE --now
